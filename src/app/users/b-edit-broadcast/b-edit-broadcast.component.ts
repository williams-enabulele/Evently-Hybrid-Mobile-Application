...
@Component({
  selector: 'app-b-edit-broadcast',
  templateUrl: './b-edit-broadcast.component.html',
  styleUrls: ['./b-edit-broadcast.component.scss'],
})
export class BEditBroadcastComponent implements OnInit {
